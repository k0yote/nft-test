...
import { IERC4973 } from "../src/interfaces/IERC4973.sol";
import { IERC4906 } from "../src/interfaces/IERC4906.sol";
import { ERC4973 } from "../src/ERC4973.sol";
...
contract AccountAbstraction is ERC1271Mock {
    ...
    function take(
        ...
        returns (uint256)
    {
        return ERC4973(collection).take(to, metadata, signature);
    }
...
contract AccountBoundToken is ERC4973 {
    ...
    function getHash(address from, address to, bytes calldata metadata) public returns (bytes32) {
...
contract ERC4973Test is Test, ERC721Holder {
    ...
    function testIERC4906() public {
        assertTrue(abt.supportsInterface(type(IERC4906).interfaceId));
    }
